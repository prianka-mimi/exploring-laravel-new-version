        ...
        <div class="header">
            <div class="header-left">
                <a href="{{ url('/') }}" class="logo">
                    <img src="{{ asset('contents/admin') }}/img/logo.png" width="35" height="35" alt="">
                    <span>Mediplus</span>
                </a>
            </div>
            <a id="toggle_btn" href="javascript:void(0);"><i class="fa fa-bars"></i></a>
            <a id="mobile_btn" class="mobile_btn float-left" href="#sidebar"><i class="fa fa-bars"></i></a>
            <div class="float-left py-1 mx-5">
                <form class="d-flex" role="search">
                    <input class="form-control me-2 rounded" type="search" placeholder="Search Here..."
                        aria-label="Search">
                </form>
            </div>
            <ul class="nav user-menu float-right">
                            ...
                            <ul class="notification-list">
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media">
                                            <span class="avatar">
                                                <img alt="John Doe" src="{{ asset('contents/admin') }}/img/user.jpg"
                                                    class="img-fluid">
                                            </span>
                ...
                <li class="nav-item dropdown d-none d-sm-block">
                    ...
                    {{-- message - from dashboard page part start --}}
                    ...
                    {{-- message - from dashboard page part end --}}
                </li>
                <li class="nav-item dropdown has-arrow">
                    <a href="#" class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
                        <span class="user-img">
                            <img class="rounded-circle" src="{{ asset('contents/admin') }}/img/user.jpg"
                                width="24" alt="Admin">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="{{ route('log-out') }}">Logout</a>
                    </div>
                </li>
            </ul>
