...
// custom show hide toggle password part start
function togglePassword1() {
    var x = document.getElementById("custom_password1");
    if (x.type === "password") {
      x.type = "text";
    } else {
      x.type = "password";
...
function togglePassword2() {
    var x = document.getElementById("custom_password2");
    if (x.type === "password") {
      x.type = "text";
    } else {
      x.type = "password";
...
// custom show hide toggle password part end
